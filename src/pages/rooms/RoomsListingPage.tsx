...
const hotelGalleryImages = [
  { src: 'https://pub-8638b9dc92c2463b812e5fea5b32e051.r2.dev/camere/camere-26.webp', alt: 'Hotel Astoria cameră 26' },
  { src: 'https://pub-8638b9dc92c2463b812e5fea5b32e051.r2.dev/camere/camere-27.webp', alt: 'Hotel Astoria cameră 27' },
  { src: 'https://pub-8638b9dc92c2463b812e5fea5b32e051.r2.dev/camere/camere-18.webp', alt: 'Hotel Astoria cameră 18' },
  { src: 'https://pub-8638b9dc92c2463b812e5fea5b32e051.r2.dev/camere/camere-11.webp', alt: 'Hotel Astoria cameră 11' },
  { src: 'https://pub-8638b9dc92c2463b812e5fea5b32e051.r2.dev/camere/camere-4.webp', alt: 'Hotel Astoria cameră 4' },
  { src: 'https://pub-8638b9dc92c2463b812e5fea5b32e051.r2.dev/camere/camere-9.webp', alt: 'Hotel Astoria cameră 9' },
...
export function RoomsListingPage() {
  ...
  const goNext = useCallback(() => {
    setLightboxIndex((prev) => (prev !== null ? (prev + 1) % hotelGalleryImages.length : null))
  }, [])

  const goPrev = useCallback(() => {
    setLightboxIndex((prev) => (prev !== null ? (prev - 1 + hotelGalleryImages.length) % hotelGalleryImages.length : null))
  }, [])
