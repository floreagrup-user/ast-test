  ...
  blog: {
    ...
    albaIulia24h: {
      ...
      references: {
        title: 'Referințe',
        items: [
          { text: 'Cetatea Alba Carolina: program de vizitare și experiențe unice — Transylvania.news', url: 'https://transylvania.news' },
          { text: 'Catedrala Romano-Catolică „Sfântul Mihail" — Turism.apulum.ro', url: 'https://turism.apulum.ro' },
          { text: 'Sala Unirii — Turism.apulum.ro', url: 'https://turism.apulum.ro' },
          { text: 'Ceremonialul schimbului de gardă – Garda Cetății Alba Carolina — Turism.apulum.ro', url: 'https://turism.apulum.ro' },
          { text: 'Dante Café & Dine | Alba Iulia — Facebook', url: 'https://facebook.com' },
          { text: 'PUB 13 — Restaurantul Cetății — Pub13.ro', url: 'https://pub13.ro' },
